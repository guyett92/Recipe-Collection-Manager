...
public class Ingredient {
    ...
    public Ingredient addIngredient() {
        ...
        setNameOfIngredient(nameOfIngredient);        
           ...
           //Do-while loop used to check if the options the user inputs are valid
            do{ System.out.println("Please enter the unit of measurement for " + nameOfIngredient + ". You may choose from the following options: Cups, Ounces, Teaspoons, Tablespoons, or Grams. Please enter one of the preceding below.");
                if (scnr.hasNext()) {
    ...
    if (sysContinue) {
        System.out.println("Please enter the number of calories per " + unitMeasurement + " of " + nameOfIngredient + " as a positive whole number: ");
        sysContinue = false;
