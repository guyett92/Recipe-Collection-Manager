...
public class Recipe {
    ...
    */
    ...
    public void addInstructions() {
        ...
        while(true) {
            System.out.print("Please enter instructions or type 'end' to stop entering instructions.\n> ");
    ...
    public Recipe addNewRecipe() {
        ...
        if (scnr.hasNextInt()) {
            ...
            if (servings < 1 || servings > 100) {
                System.out.print(servings + " is not a valid number of servings. Please enter a positive integer.\n> ");
                if(scnr.hasNextInt()) {
                     if (servings < 1 || servings > 100) {
        ...
        do {
            System.out.print("Would you like to enter an ingredient? (y for 'yes' or n for 'no')\n> ");
